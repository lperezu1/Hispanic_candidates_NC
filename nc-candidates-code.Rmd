...
# Import datasets
```{r}
nc_voter = read.delim("./datasets/ncvoter_Statewide.txt", sep = "\t")
candidates <- read_csv("./datasets/Candidate_Listing_2022.csv")
```
...
```{r}
write.csv(HISPANIC_CANDIDATES, file = "HISPANIC_CANDIDATES.csv")
```
